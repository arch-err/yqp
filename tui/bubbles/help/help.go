...
func New(yqtheme theme.Theme) Bubble {
	...
	model := help.New()
	model.Styles.ShortKey = styles.helpKeyStyle.Foreground(yqtheme.Primary)
	model.Styles.ShortDesc = styles.helpTextStyle.Foreground(yqtheme.Secondary)
	model.Styles.ShortSeparator = styles.helpSeparatorStyle.Foreground(yqtheme.Inactive)
